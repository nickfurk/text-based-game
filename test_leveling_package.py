...
class TestLevelingPackage(TestCase):
    def test_leveling_package_player_level_change_based_on_experience(self):
    ...
    def test_leveling_package_player_class_dictionary_change_based_on_experience(self):
        player = {'category': 'player',
                  'class': 'Warrior',
                  'class_dictionary': {'accuracy_rate': 50,
                                       'attack_name': 'Threaten',
