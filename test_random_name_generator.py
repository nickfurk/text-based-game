...
class TestRandomNameGenerator(TestCase):
    ...
    @patch('game.generate', side_effect=[['Random', 'Name'], ['Stirring', 'Lyrebird']])
    def test_random_name_generator_select_choose_another_random_name(self, mock_generate, mock_input):
        actual = random_name_generator()
        expected = "Stirring Lyrebird"
        self.assertEqual(actual, expected)
    ...
    def test_random_name_generator_choose_random_correct_print(self, mock_stdout, mock_generate, mock_input):
        expected = "\u001b[32;1mStirring Lyrebird\u001b[0m was created randomly! Would you like to choose your " \
    ...
    @patch('game.generate', side_effect=[['Random', 'Name'], ['Stirring', 'Lyrebird']])
    @patch('sys.stdout', new_callable=io.StringIO)
    def test_random_name_generator_choose_another_correct_print(self, mock_stdout, mock_generate, mock_input):
        expected = "\u001b[32;1mRandom Name\u001b[0m was created randomly! Would you like to choose your " \
                   "own name or create another at random?\n\n" \
                   "{1: 'I would like to choose this name!'\n" \
                   " 2: 'I would like to choose another one at random'\n" \
                   " 3: 'I would like to choose my own name!'}\n\n" \
